...
void CHandlingManagerSA::CheckSuspensionChanges ( CHandlingEntry* pEntry )
{
    ...
    if ( bChanged == true && pEntry->HasSuspensionChanged ( ) == false )
    {
        ...
        if ( gpMultiplayer->IsSuspensionEnabled ( ) == false )
            // Install the hook
			gpMultiplayer->SetSuspensionEnabled(true);
	...
	if (iChangedVehicles == 0 && gpMultiplayer->IsSuspensionEnabled() == true)
		gpMultiplayer->SetSuspensionEnabled(false);
}
