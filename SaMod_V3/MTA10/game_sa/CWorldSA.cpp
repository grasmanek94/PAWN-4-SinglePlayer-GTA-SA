...
{
	gpMultiplayer->SetAircraftMaxHeight(fHeight);
}

float CWorldSA::GetAircraftMaxHeight ( void )
{
	return gpMultiplayer->GetAircraftMaxHeight();
}

void CWorldSA::SetAircraftMaxVelocity ( float fVelocity )
{
	gpMultiplayer->SetAircraftMaxVelocity(fVelocity);
}

float CWorldSA::GetAircraftMaxVelocity ( void )
{
	return gpMultiplayer->GetAircraftMaxVelocity();
}
