...
bool CallBreakTowLinkHandler ( CVehicleSAInterface * vehicle )
{
    ...
    if ( pVehicle )
        return internal__samod::OnBreakTowLink(pVehicle);
    return true;
}
...
void _declspec(naked) HOOK_CRadar__DrawRadarGangOverlay()
{
    ...
    internal__samod::DrawRadarGangOverlay();
...
//                    TIMING_CHECKPOINT( "+TriggerVehDamEvent" );
                    if ( pEntity->nType == ENTITY_TYPE_VEHICLE )
                    {
                        ...
                        internal__samod::VehicleCollisionHandler ( pCollisionVehicle, pEntity, pEntity->m_nModelIndex, pCollisionVehicle->m_fDamageImpulseMagnitude, pInterface->m_fDamageImpulseMagnitude, pCollisionVehicle->m_usPieceType, pCollisionVehicle->m_vecCollisionPosition, pCollisionVehicle->m_vecCollisionImpactVelocity );
                    }
                    else
                    {
                        internal__samod::VehicleCollisionHandler ( pCollisionVehicle, pEntity, pEntity->m_nModelIndex, pCollisionVehicle->m_fDamageImpulseMagnitude, 0.0f, pCollisionVehicle->m_usPieceType, pCollisionVehicle->m_vecCollisionPosition, pCollisionVehicle->m_vecCollisionImpactVelocity );
                    }
//                    TIMING_CHECKPOINT( "-TriggerVehDamEvent" );
                }
            }
