...
public:
	...
	HRESULT		Print		( float x, float y, DWORD color, const char *szText, bool textcoloring = false);
	HRESULT		PrintShadow ( float x, float y, DWORD color, const char *szText, bool textcoloring = false);

	float		DrawLength ( const char *szText, bool textcoloring = false ) const;
...
public:
	...
	void	D3DBox ( float x, float y, float w, float h, D3DCOLOR color, bool clip = false );
	void	D3DBoxi ( int x, int y, int w, int h, D3DCOLOR color, int maxW, bool clip = false );
	void	D3DBoxBorder ( float x, float y, float w, float h, D3DCOLOR border_color, D3DCOLOR color, bool clip = false );
	void	D3DBoxBorderi ( int x, int y, int w, int h, D3DCOLOR border_color, D3DCOLOR color, bool clip = false );

	bool	DrawLine ( const D3DXVECTOR3 &a, const D3DXVECTOR3 &b, DWORD dwColor, bool clip = false );
	bool	DrawTriangleInWorld ( const D3DXVECTOR3 &a, const D3DXVECTOR3 &b, const D3DXVECTOR3 &c, DWORD dwColor, bool clip );
	bool	DrawRectangleInWorld ( const D3DXVECTOR3 &a, const D3DXVECTOR3 &b, const D3DXVECTOR3 &c, const D3DXVECTOR3 &d, DWORD dwColor, bool clip );
